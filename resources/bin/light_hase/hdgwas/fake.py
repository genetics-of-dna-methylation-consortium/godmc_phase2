...
class Encoder(object):
    ...
    def save_npy(self, data, save_path=None, info=None, index=None):
        ...
        self.phen_info_dic[str(self.npy_iter[save_path]) + '_' + self.study_name + '.npy'] = info._data.names[
    ...
    def save_csv(self, data, save_path=None, info=None, index=None):
        ...
        df.to_csv(os.path.join(save_path, str(self.npy_iter[save_path]) + '_' + self.study_name + '.csv'), sep='\t',
                  index=False)
        self.npy_iter[save_path] += 1
