...
###############################################################################
srcdir=.
utils_testdir=/user/home/epzjlm/scratch/repo/EPIC_mQTL/resources/bin/hdf5-1.12.2/utils/test
testdir=/user/home/epzjlm/scratch/repo/EPIC_mQTL/resources/bin/hdf5-1.12.2/test
