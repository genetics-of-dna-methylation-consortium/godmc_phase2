...
aggregate <- function(type){
	message(paste0("Checking all ", type, " files are present"))
	fs <- paste0(rootname, "_", type, ".", 1:n_chunks, ".RData")
	...
	save(norm.beta, file=paste0(rootname,"_", type, ".RData"))
	message(paste0("Successfully aggregated all ", type, " chunks"))
