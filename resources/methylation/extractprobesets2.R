...
suppressMessages(library(matrixStats))
	...
	write.table(norm.beta.subset, paste(probedir,"/methylation.subset.",p1,".txt",sep=""),sep=" ",na = "-9",col.names=T,row.names=F,quote=F)
    ...
    write.table(covs,cov_out ,sep=" ",na = "NA",col.names=F,row.names=F,quote=F)    
